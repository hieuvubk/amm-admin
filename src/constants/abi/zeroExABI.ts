    ...
    outputs: [
      {
        ...
        components: [
          ...
          {
            name: 'sellMakerRemainingAmountAfterMatch',
            type: 'uint256',
          },
          {
            name: 'sellTakerRemainingAmountAfterMatch',
            type: 'uint256',
          },
          {
            name: 'buyMakerRemainingAmountAfterMatch',
            type: 'uint256',
          },
          {
            name: 'buyTakerRemainingAmountAfterMatch',
            type: 'uint256',
          },
          {
            name: 'changeMakerTokenForTaker',
            type: 'uint256',
          },
        ],
      },
